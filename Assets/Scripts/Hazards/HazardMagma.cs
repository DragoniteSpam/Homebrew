...
public class HazardMagma : Hazard {
    ...
    public static void SpawnBlob(GameObject what) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            blob.GetComponentInChildren<SpriteRenderer>().sprite = HomebrewGame.Me.spritesMud[Random.Range(0, HomebrewGame.Me.spritesMud.Count - 1)];
            blob.GetComponentInChildren<SpriteRenderer>().material.color = Color.red;
