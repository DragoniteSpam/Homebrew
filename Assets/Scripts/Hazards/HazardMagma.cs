...
public class HazardMagma : Hazard {
    ...
    public static void SpawnBlob(GameObject what) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            SpriteRenderer renderer = blob.GetComponentInChildren<SpriteRenderer>();
            renderer.sprite = HomebrewGame.Me.spritesMud[Random.Range(0, HomebrewGame.Me.spritesMud.Count - 1)];
